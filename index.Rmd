---
title: "**<b style = 'color : #E34B2A;'>Sesión 1: Introducción a R y RStudio</b>**"
...
class(df_usa) 
head(df_usa)
summary(df_usa) # Resumen estadistico
...
estamos filtrando de la data `usa.sav` las personas que son judíos
...
- [Karina Alcántara & Lizette Crispín (2023)](https://karinaalc.github.io/Estadistica-2/pd1.html).
